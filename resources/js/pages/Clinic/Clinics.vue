            ...
            <div class="w-full">
                ...
                <!-- <div class="px-4 py-4 md:px-10 md:py-7">
                    <div class="flex items-center justify-between">
                        <div
                            class="flex cursor-pointer items-center rounded bg-gray-200 px-4 py-3 text-sm leading-none font-medium text-gray-600 hover:bg-gray-300">
                            <p>Sort By:</p>
                                ...
                                <tr v-for="clinic in clinics" :key="clinic.id" class="h-16 rounded border border-gray-100 focus:outline-none">
                                    ...
                                    <td class="">
                                        <div class="flex items-center pl-5">
                                            <p class="mr-2 text-base leading-none font-medium text-gray-700">{{ clinic.name }}</p>
